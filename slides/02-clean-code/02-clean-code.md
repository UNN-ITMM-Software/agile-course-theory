...
# Хорошо и плохо
  ...
  - Плохо:
    - Длинный
    - Запутанный, сложный, заумный
    - Повторяющийся
    - Избыточный, шумный, визуально нагруженный

# Преимущества чистого кода

  - Программист в основном не пишет, а читает код
  - Ускорение понимания кода => ускорение работы:
...
> - Требование быстрых решений
  - Различная квалификация сотрудников
  - Отсутствие стандарта (коллективное владение)
  - Низкая культура (плохая ответственность)
  - Сторонний код (старый код)
...
> Программист не стал выдумывать и назвал детей новый сын(1) и новый сын(2)
