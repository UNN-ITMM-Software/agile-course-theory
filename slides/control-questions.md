...
## 1. Введение в Agile Development
  ...
  1. Приведите различнные закономерности, объединяющие размер команды, методологии и сложность решаемой проблемы
...
## 7. SOLID: Object-Oriented Design Principles
...
## 8. Дизайн презентационного слоя
