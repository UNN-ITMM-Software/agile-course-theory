...
<!-- TODO
  - Удалить метафору со шляпой?
  - Понятие software entropy (вставить титульную картинку из Clean Code)
  - Метафоры: правило бойскаута, fixing broken windows, technical debt,
    уборка посуды
...
# Техника безопасности
  ...
  - Рефакторинг без тестов недопустим
  - Не стоит увлекаться
  - Полезная рекомендация: включите рефакторинг в свой рабочий цикл (+20-30%)
